...
import { createSwipeSubscription, SwipeEvent } from './swipe-core';
...
export class SwipeDirective implements OnInit, OnDestroy {
  ...
  @Output() swipeMove: EventEmitter<SwipeEvent> =
    new EventEmitter<SwipeEvent>();
  ...
  ngOnInit() {
    this.zone.runOutsideAngular(() => {
      this.swipeSubscription = createSwipeSubscription({
        ...
        onSwipeMove: (swipeMoveEvent: SwipeEvent) =>
